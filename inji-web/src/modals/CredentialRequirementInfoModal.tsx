...
interface CredentialRequirementInfoModalProps {
...
function CredentialRequirementInfoModal({
    verifier,
    onClose,
}: CredentialRequirementInfoModalProps) {
                    ...
                    >
                        ...
                        <div className={styles.sectionsCard}>
                            <div className={styles.sectionRow}>
                                <div className={`${styles.sectionIconOne} ${styles.sectionIcon}`} aria-hidden>
                                ...
                                <div className={styles.sectionBody}>
                                    <div className={styles.sectionTitleRow}>
                                        ...
                                        <span className={`${styles.statusBadge} ${styles.requiredBadge}`}>
                                            {t("dcql.required")}
                                        </span>
                                    </div>
                            ...
                            <div className={styles.sectionRow}>
                                <div className={`${styles.sectionIconTwo} ${styles.sectionIcon}`} aria-hidden>
                                ...
                                <div className={styles.sectionBody}>
                                    <div className={styles.sectionTitleRow}>
                                        ...
                                        <span className={`${styles.statusBadge} ${styles.optionalBadge}`}>
